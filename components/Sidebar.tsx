...
interface SidebarProps {
  ...
  onClose: () => void;
  onGoHome: () => void;
  onGoToTrading: () => void; // This is now used to just set the tab in DashboardPage
}

export const Sidebar: React.FC<SidebarProps> = ({ activeTab, onTabChange, onLogout, isOpen, onClose, onGoHome, onGoToTrading }) => {
    ...
    <>
      ...
      >
        ...
        <div className="p-4 border-t border-slate-800 shrink-0">
          <button onClick={onGoHome} className="w-full flex items-center justify-center px-4 py-2 text-sm font-medium text-slate-400 hover:text-white hover:bg-slate-800 rounded-lg transition-colors mb-2">
